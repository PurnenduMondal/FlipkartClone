...
<head>
    ...
    <!-- JavaScript Link -->
    <script type="text/javascript" src="<?php echo e(asset('js/UserProfile.js')); ?>"></script>
...
<?php endif; ?>
    ...
    <div class="profileContainer">
        ...
        <div class="profile__content">
            <form action="<?php echo e(route('submit_personal_info')); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="profile__inputContainer">
                    <div class="profile__input" style="margin: 0">
                        <div class="profile__nameInput">
                            <input type="text" name="first_name" id="" value="<?php echo e(Auth::user()->first_name); ?>" required>
                            <label for="">First Name</label>
                        </div>
                        <div class="profile__nameInput">
                            <input type="text" name="last_name" id="" value="<?php echo e(Auth::user()->last_name); ?>" required>
                    ...
                    <div style="margin-bottom: 46px;">
                        ...
                        <input style="transform: scale(1.3);padding-right: 5px;cursor: pointer;" type="radio"
                            name="gender" value="female" id="female" <?php echo e(Auth::user()->gender == 'female' ? 'checked' : ''); ?>>
            ...
            <form action="<?php echo e(route('submit_email')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="profile__contentTitle">
                ...
                <div class="profile__input">
                    <div method="post" class="profile__nameInput">
                        <input type="email" name="email" id="" required value="<?php echo e(Auth::user()->email); ?>">
            ...
            <form action="<?php echo e(route('submit_address')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="profile__contentTitle">
                ...
                <div class="profile__inputContainer">
                    ...
                    <div class="profile__input">
                        <div class="profile__nameInput" style="width:530px">
                            <input type="text" name="address" id="" required value="<?php echo e(Auth::user()->address); ?>">
...
</body><?php /**PATH G:\xampp\htdocs\FlipkartClone\resources\views/UserProfile.blade.php ENDPATH**/ ?>